...
const EmployeeProfile = () => {
  ...
  const getScore = employee => {
    ...
    const github =
      employee && employee.github && employee.github.githubHandle && 10;
    const bootcamp =
      employee &&
      employee.education &&
      employee.education.bootCamp &&
      employee.education.bootCamp.length > 0 &&
      10;
    const university =
      employee &&
      employee.education &&
      employee.education.universities &&
      employee.education.universities.length > 0 &&
      10;
    console.log(github);
    ...
    return (
      employee.skills.map(skill => skill.level).reduce((a, b) => a + b, 0) +
      github +
      bootcamp +
      university
    );
